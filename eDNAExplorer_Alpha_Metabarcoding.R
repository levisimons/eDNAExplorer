...
tryCatch(
  {
    ...
    if(nrow(TronkoDB) > 1){
      ...
      system(paste("aws s3 cp s3://ednaexplorer/analysis/Categories.csv ",category_file," --endpoint-url https://js2.jetstream-cloud.org:8001/",sep=""))
      ...
      system(paste("aws s3 cp s3://ednaexplorer/analysis/LabelsAndLegends.csv ",legends_file," --endpoint-url https://js2.jetstream-cloud.org:8001/",sep=""))
