...
tryCatch(
  {
    ...
    TronkoTile_tmp <- paste(Marker,"_prevalence_",UUIDgenerate(),".csv",sep="")
    ...
    TronkoInput <- fread(file=TronkoTile_tmp, header = TRUE, sep = ",", skip = 0, fill = TRUE, check.names = FALSE, quote = "\"", encoding = "UTF-8", na = c("", "NA", "N/A"))
